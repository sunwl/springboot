 ...
 * <p>
 * 其实关键点在于两个： 1、配置order属性:视图解析器优先级问题（就是决定先使用哪个解析器来解析视图）
...
public class ViewResolverConfiguration {
    ...
    public class WebConfig extends WebMvcConfigurerAdapter {
        ...
        /**
         * 下面都是配置hymeleaf的视图解析器相关的内容 对thymeleaf的视图解析器，解析到webapp下的html目录下查找对应的页面
         *
         * @return
         */
        @Bean
        ...
        public ThymeleafViewResolver viewResolverThymeLeaf() {
            ...
            // 下面是设置该视图解析器所要匹配哪些格式的视图"html/*",
            // "vue/*","jsps/*","templates/*"代表匹配"html/*",
            // "vue/*","jsps/*","templates/*"格式的所有视图
